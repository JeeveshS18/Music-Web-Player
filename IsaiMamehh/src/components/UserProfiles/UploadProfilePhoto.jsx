...
const UploadProfilePhoto = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data.append("upload_preset", "IsaiMamehh"); //! Add the upload preset
      data.append("cloud_name", "dbhmuvh6j"); //! Add the Cloudinary cloud name

      //! Connect Cloudinary API and Send File => window.fetch();
      const response = await fetch(
        `https://api.cloudinary.com/v1_1/dbhmuvh6j/image/upload`,
        {
          method: "POST",
          body: data,
        }
